...
// === Solution 1===//
var value = prompt("Enter car id");
for (var i = 0; i < inventory.length; i++) {
  if (inventory[i].id == value) {
    console.log(
      `Car ${inventory[i].id} is a ${inventory[i].car_year} ${
...
var lastsCar = inventory.pop();
console.log(`Make: ${lastsCar.car_make} and model ${lastsCar.car_model}`);
